    ...
    <div class="container">
        <div class="calendar-container">
            <div class="calendar-header">
                <h1 id="calendarYear">CALENDAR FOR PRESENT YEAR</h1>
            </div>
        ...
        <div class="previous-button-container">
            <p>To view the previous year calendar, press this button:</p>
            <button class="previous-button" onclick="window.location.href='previous.php'">Previous Year</button>
        </div>
    </div>
